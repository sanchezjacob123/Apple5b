...
<head>
    ...
    <link rel="stylesheet" href="/Apple5b/public/css/style.css">
</head>
<body>

<div class="container">
    <h1>Lista de Personas</h1>
    <a href="/Apple5b/public/persona/create"><button>Agregar</button></a>
                ...
                <?php foreach ($personas as $persona): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($persona['elsexo']); ?></td> <td><?php echo htmlspecialchars($persona['elestadocivil']); ?></td> <td>
                            <a href="/Apple5b/public/persona/view?idpersona=<?php echo htmlspecialchars($persona['idpersona']); ?>">
                                <button>View</button>
                            </a>
                            <a href="/Apple5b/public/persona/edit?idpersona=<?php echo htmlspecialchars($persona['idpersona']); ?>">
                                <button>Editar</button>
                            </a>
                            <a href="/Apple5b/public/persona/deleteForm?id=<?php echo htmlspecialchars($persona['idpersona']); ?>"
...
<script src="/Apple5b/public/js/script.js"></script>
</body>
</html>
